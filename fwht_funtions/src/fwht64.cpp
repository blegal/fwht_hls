...
float flip_sign_bit(float x, uint8_t bit) {
    union {
        float f;
        uint32_t u;
    } v = {x};
...
float32x8_t addsub_fx(const float32x8_t A, const float32x8_t B, const u_int8_t S, const int stage)
{
...
float32x8_t addsub_x4(const float32x8_t A)
{
    float32x8_t C;
    C.v[0] = A.v[0] + A.v[4];
    C.v[1] = A.v[1] + A.v[5];
...
float32x8_t addsub_x2(const float32x8_t A)
{
    float32x8_t C;
    C.v[0] = A.v[0] + A.v[2];
    C.v[1] = A.v[1] + A.v[3];
...
float32x8_t addsub_x1(const float32x8_t A)
{
    float32x8_t C;
    C.v[0] = A.v[0] + A.v[1];
    C.v[1] = A.v[0] - A.v[1];
...
#endif
#pragma HLS ALLOCATION function instances=addsub_fx limit=2
//#pragma HLS PIPELINE
